...
**Example Implementation**: See [Laculine](https://www.laculine.com), our consulting demo site. Click "Risk Ratings" to see how Fluvial document data can be rendered as interactive web reports.
